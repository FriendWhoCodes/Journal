          ...
          <form onSubmit={handleStep1Continue} className="bg-white rounded-2xl shadow-xl p-8 md:p-10">
            ...
            <div className="mb-8">
              <label className="block text-xl font-bold text-gray-900 mb-4">
                🎯 What are the top 3 things you want to achieve this year?
              </label>
            ...
            <div className="mb-8">
              <label className="block text-xl font-bold text-gray-900 mb-4">
                💡 What&apos;s the main idea or theme you want to embody this year?
              </label>
              <input
                type="text"
                value={mainTheme}
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-amber-50 py-8 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">
            Life isn&apos;t just about work - what do you want to experience this year?
          </p>
        </div>
        ...
        <form onSubmit={handleStep2Continue} className="bg-white rounded-2xl shadow-xl p-8 md:p-10">
          ...
          <div className="mb-8">
            <label className="block text-xl font-bold text-gray-900 mb-4">
              🎬 Movies/Series I want to watch this year
            </label>
            <textarea
              value={moviesToWatch}
          ...
          <div className="mb-8">
            <label className="block text-xl font-bold text-gray-900 mb-4">
              ✨ Experiences I want to create this year
            </label>
            <textarea
